...
<body>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/ar-condicionado/ar-condicionado-bg.jpg'); background-position: top center;">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <h1 class="mb-2 bread">Ar Condicionado</h1>
                </div>
            </div>
        </div>
    </section>

    <section class="ftco-section ftco-about ftco-no-pt ftco-no-pb ftco-counter" id="section-counter" style="margin-top:40px">
            ...
            <div class="row d-flex align-items-stretch">
                <div class="col-md-12">
                    <div class="marcas-ar-condicionado">
                        <figure>
                            <img src="images/ar-condicionado/marcas-de-ar-condicionados-2.png" alt="Marcas ar-condicionado">
                        </figure>
                    </div>
                </div>
            </div>
